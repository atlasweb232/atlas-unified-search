...
const sourceEnv = {
  ...
  google_drive: ['GOOGLE_CLIENT_ID', 'GOOGLE_CLIENT_SECRET', 'GOOGLE_REFRESH_TOKEN', 'GOOGLE_SERVICE_ACCOUNT_JSON', 'GDRIVE_FOLDER_IDS', 'GDRIVE_WEBHOOK_TOKEN', 'GDRIVE_WEBHOOK_CHANNEL_IDS', 'GDRIVE_EVENT_TENANT_ID', 'GDRIVE_EVENT_USER_ID'],
  conference_bridge: ['AZURE_STORAGE_CONNECTION_STRING', 'CONFERENCE_BLOB_CONTAINERS', 'CONFERENCE_EVENT_GRID_TOKEN', 'CONFERENCE_EVENT_TENANT_ID', 'CONFERENCE_EVENT_USER_ID'],
